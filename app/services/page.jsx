...
const services = [
  ...
  { title: "Data Analyst", icon: "bi-gear", desc: "Data analyst tailored to business needs.", path: "/services/customapps" },
  { title: "Data Science", icon: "bi-gear", desc: "Data Science tailored to business needs.", path: "/services/customapps" },
  { title: "AI/Ml", icon: "bi-gear", desc: "Data Science tailored to business needs.", path: "/services/customapps" },
  { title: "Cloud computing", icon: "bi-gear", desc: "Data Science tailored to business needs.", path: "/services/customapps" },
];
  ...
  return (
    <main className="flex flex-col items-center space-y-20 mt-20">
      ...
      <section className="w-full text-center py-20 bg-gray-100">
        <h1 className="text-4xl font-bold text-gray-800">We Offer High-Demand Candidate</h1>
